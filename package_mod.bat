...
set "mod_name=Yoshimo's Remorse"
set mod_version=v3.3
set mod_folder=yoshimosremorse
...
set audio_folder=%mod_folder%\audio-en
set tispack_folder=%mod_folder%\tiz
set iconv_folder=%mod_folder%\language\iconv
set mod_readme=https://gibberlings3.github.io/Documentation/readmes/readme-yr.html
